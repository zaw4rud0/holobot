...
import dev.zawarudo.holo.anime.BestAnimesCmd;
import dev.zawarudo.holo.anime.CharacterSearchCmd;
import dev.zawarudo.holo.anime.MangaSearchCmd;
import dev.zawarudo.holo.annotations.Deactivated;
import dev.zawarudo.holo.config.ConfigCmd;
import dev.zawarudo.holo.development.AoCStatsCmd;
import dev.zawarudo.holo.development.CollageCmd;
import dev.zawarudo.holo.games.akinator.AkinatorCmd;
import dev.zawarudo.holo.games.akinator.AkinatorCmdOld;
...
import dev.zawarudo.holo.image.meme.GenerateCmd;
