...
public class ServerInfoCmd extends Command {
	...
	public void onCommand(MessageReceivedEvent e) {
		...
		// Count normal and animated emotes
		...
		builder.addField("Additional Checks", "Normal Emotes: `" + normalCount + " / " + e.getGuild().getMaxEmotes() + "`\n" + "Animated Emotes: `" + animatedCount + " / "
				+ e.getGuild().getMaxEmotes() + "`\n" + "Channels: `" + e.getGuild().getChannels().size() + " / 500`\n" + "Roles: `" + e.getGuild().getRoles().size() + " / 250`", false);
